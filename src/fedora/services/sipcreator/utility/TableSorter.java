...
public class TableSorter extends AbstractTableModel {
    ...
    private static final long serialVersionUID = 4049634581613130294L;
    ...
    public TableSorter(TableModel newTableModel) {
        setTableModel(newTableModel);
    }

    public TableSorter(TableModel newTableModel, JTableHeader newTableHeader) {
    ...
    private static class Arrow implements Icon {
        ...
        public Arrow(boolean newDescending, int newSize, int newPriority) {
    ...
    private class SortableHeaderRenderer implements TableCellRenderer {
        ...
        public SortableHeaderRenderer(TableCellRenderer newTableCellRenderer) {
            tableCellRenderer = newTableCellRenderer;
        }
    ...
    private static class Directive {
        ...
        public Directive(int newColumn, int newDirection) {
            column = newColumn;
